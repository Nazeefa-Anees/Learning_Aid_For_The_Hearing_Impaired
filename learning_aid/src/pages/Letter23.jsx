...
import twentythree from '../assets//dataset_icons/letters/23.jpg';
...
export default function Letter23() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-16 top-5'>ia </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={twentythree} alt="Letter23" className="image" />
      </div>
