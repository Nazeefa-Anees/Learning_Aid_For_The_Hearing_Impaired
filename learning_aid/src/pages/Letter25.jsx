...
import twentyfive from '../assets//dataset_icons/letters/26.jpg';
...
export default function Letter25() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-5'>! </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={twentyfive} alt="Letter25" className="image" />
      </div>
