...
import seventeen from '../assets//dataset_icons/letters/17.jpg';
...
export default function Letter17() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-6'>us </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={seventeen} alt="Letter17" className="image" />
      </div>
