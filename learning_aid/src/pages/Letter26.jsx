...
import twentysix from '../assets//dataset_icons/letters/25.jpg';
...
export default function Letter26() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-5'>ps </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={twentysix} alt="Letter26" className="image" />
      </div>
