...
import six from '../assets//dataset_icons/letters/10.jpg';
...
export default function Letter6() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-5'>t </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={six} alt="Letter6" className="image" />
      </div>
