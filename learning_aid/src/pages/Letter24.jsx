...
import twentyfour from '../assets//dataset_icons/letters/24.jpg';
...
export default function Letter24() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-16 top-5'>ya </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={twentyfour} alt="Letter24" className="image" />
      </div>
