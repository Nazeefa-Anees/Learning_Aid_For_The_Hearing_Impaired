...
import number6 from '../assets/dataset_icons/numbers/6.jpg';
...
export default function Number6() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-3'>6 </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={number6} alt="number6" className="image" />
      </div>
