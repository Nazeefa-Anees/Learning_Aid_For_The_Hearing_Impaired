...
import eight from '../assets//dataset_icons/letters/6.jpg';
...
export default function Letter8() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-16 top-4'>la </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={eight} alt="Letter8" className="image" />
      </div>
