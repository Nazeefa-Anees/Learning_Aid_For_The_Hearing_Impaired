...
import number4 from '../assets/dataset_icons/numbers/4.jpg';
...
export default function Number4() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-3'>4 </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={number4} alt="number4" className="image" />
      </div>
