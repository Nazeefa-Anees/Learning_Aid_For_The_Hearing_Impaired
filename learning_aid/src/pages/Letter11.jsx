...
import eleven from '../assets//dataset_icons/letters/11.jpg';
...
export default function Letter11() {
  ...
  return (
    <div className="page-container">
     ...
     {/*Text*/}
     <div className="box1">
        <h1 className="font-custom text-7xl text-center mt-8  whitespace-pre-wrap absolute left-0 right-0 top-5">
          oA{" "}
        </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={eleven} alt="Letter11" className="image" />
      </div>
