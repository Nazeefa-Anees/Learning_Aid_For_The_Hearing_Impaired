...
import eightteen from '../assets//dataset_icons/letters/18.jpg';
...
export default function Letter18() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-16 top-5'>ha </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={eightteen} alt="Letter18" className="image" />
      </div>
