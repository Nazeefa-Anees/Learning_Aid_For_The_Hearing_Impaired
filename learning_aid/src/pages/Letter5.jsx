...
import five from '../assets//dataset_icons/letters/5.jpg';
...
export default function Letter5() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-16 top-4'>W </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={five} alt="Letter5" className="image" />
      </div>
