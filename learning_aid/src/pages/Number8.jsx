...
import number8 from '../assets/dataset_icons/numbers/8.jpg';
...
export default function Number8() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-3'>8 </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={number8} alt="number8" className="image" />
      </div>
