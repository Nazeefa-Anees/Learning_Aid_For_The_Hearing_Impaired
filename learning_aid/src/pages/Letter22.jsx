...
import twentytwo from '../assets//dataset_icons/letters/22.jpg';
...
export default function Letter22() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-5'>js </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={twentytwo} alt="Letter22" className="image" />
      </div>
