...
import sixteen from '../assets//dataset_icons/letters/16.jpg';
...
export default function Letter16() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-20 top-4'>ns </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={sixteen} alt="Letter16" className="image" />
      </div>
