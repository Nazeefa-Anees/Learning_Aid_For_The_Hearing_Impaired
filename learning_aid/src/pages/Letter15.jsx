...
import fifteen from '../assets//dataset_icons/letters/15.jpg';
...
export default function Letter15() {
  return (
    <div className="page-container">
      ...
      {/*Text*/}
      <div className="box1">
        <h1 className='font-custom text-9xl text-center mt-8  whitespace-pre-wrap absolute left-16 top-6'>ma </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={fifteen} alt="Letter15" className="image" />
      </div>
