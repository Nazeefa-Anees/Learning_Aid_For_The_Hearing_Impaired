...
import twenty from '../assets//dataset_icons/letters/20.jpg';
...
export default function Letter20() {
  ...
  return (
    <div className="page-container">
     ...
     {/*Text*/}
     <div className="box1">
        <h1 className="font-custom text-7xl text-center mt-8  whitespace-pre-wrap absolute left-0 right-0 top-6">
          rA{" "}
        </h1>
      </div>
      ...
      {/*Image*/}
      <div className="box3">
        <img src={twenty} alt="Letter20" className="image" />
      </div>
